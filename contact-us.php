        ...
        <div class="contact_detail">
          ...
          <ul>
            ...
            <li>
              ...
              <div class="contact_info_m"><a href="mailto:khalidalkamel1111@gmail.com"><?php   echo htmlentities($result->EmailId); ?></a></div>
            </li>
            <li>
              <div class="icon_wrap"><i class="fa fa-phone" aria-hidden="true"></i></div>
              <div class="contact_info_m"><a href="tel:+967772758707"><?php   echo htmlentities($result->ContactNo); ?></a></div>
            </li>
          </ul>
        <?php }} ?>
        </div>
